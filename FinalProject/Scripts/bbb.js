...
document.addEventListener('DOMContentLoaded', function() {
    const ratingInputs = document.querySelectorAll('.ratingplace input');
    const ratingFeedback = document.getElementById('ratingFeedback');

    ratingInputs.forEach(input => {
        input.addEventListener('change', function() {
            ratingFeedback.textContent = `You rated this ${this.value} stars.`;
        });
    });
});
...
>>>>>>> c2d4bf9a3bdf2dd912b2602eaa41e1ada32ff0b2
//with server but without rating list